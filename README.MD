...
Inspired by the new release of the Apache Arrow parquet Rust crate https://arrow.apache.org/blog/2025/10/23/rust-parquet-metadata/, which introduced a custom Thrift parser to decode Parquet metadata 3x-9x faster than earlier versions, I implemented a benchmark comparing the custom parser (version 57.0.0) and the previous built-in decode_metadata function (version 56.x).
